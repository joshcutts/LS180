...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: joshuacutts
--
...
ALTER TABLE public.weather OWNER TO joshuacutts;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: joshuacutts
--
